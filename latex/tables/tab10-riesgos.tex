\begin{table}[H]
  ...
  \begin{tabular}{@{}p{0.22\textwidth}p{0.10\textwidth}p{0.10\textwidth}p{0.44\textwidth}@{}}
    ...
    Media & Alta &
    Documentar fórmulas y umbrales en Cap.~4; revisión cruzada del equipo; revisión académica \\
    ...
    Baja & Alta &
    Regenerar Excel desde script; trazabilidad OG--OE en revisión de cierre \\
