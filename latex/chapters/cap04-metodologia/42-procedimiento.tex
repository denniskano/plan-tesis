El procedimiento sigue las cinco fases del modelo (Anexo~C), alineadas con OE1--OE4. Este capítulo
...
\begin{enumerate}
  ...
  \item \textbf{Fase 2 --- Normalizar artefactos (OE1):} parsear el contrato OpenAPI y el material
        BIAN; producir representaciones comparables (tabular, grafo o RDF según factor elegido).
...
\input{chapters/cap04-metodologia/47-objetivos-metodologia}
