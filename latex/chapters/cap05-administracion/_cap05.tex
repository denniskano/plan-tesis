...
La \Cref{tab:cronograma} resume las fases de elaboración del plan de tesis y la
asignación de responsables. Las fases de bibliografía y redacción documentadas corresponden al avance
al cierre de mayo 2026; las fases finales concentran la metodología, la administración y la
revisión de cierre antes de la entrega formal.

\input{tables/tab09-cronograma}

\section{Presupuesto}

El plan de tesis es un producto documental académico; no requiere
...
\begin{itemize}
  ...
  \item \textbf{Recursos institucionales} de la Universidad Nacional de Ingeniería: acceso a bases
        ...
        matrícula de posgrado; uso de plataforma institucional y sesiones de asesoría académica.
...
\begin{itemize}
  ...
  \item \textbf{Jack Paitan:} sistematización bibliográfica, marco teórico §3.1--§3.4,
        diseño metodológico (Cap.~4), administración (Cap.~5), anexos y matrices Excel.
  \item \textbf{Asesor académico:} retroalimentación sobre coherencia del planteamiento y validación
        del hilo conductor antes de la entrega formal.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Fuentes documentales:} contratos OpenAPI~3.x bancarios públicos o de referencia;
        especificaciones \ServiceDomain{} BIAN; corpus bibliográfico del proyecto.
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}p{0.22\textwidth}p{0.68\textwidth}@{}}
    ...
    Jack Paitan &
    Revisión bibliográfica; §3.5--§3.6 y §3.1--§3.4; Cap.~2--4; Cap.~5; anexos A--F; matrices Excel;
    compilación PDF y entrega formal \\
    Ambos &
    Revisión de hilo conductor; matriz de consistencia; cierre del plan; decisiones de alcance
    (§1.6) \\
    \bottomrule
  \end{tabular}
\end{table}
