...
Complementa la \Cref{tab:variables} (Cap.~2) y la matriz de consistencia (Anexo~C). Los
\textbf{factores} son condiciones de diseño manipulables; los \textbf{ratios} son resultados medidos.
