...
% Enunciado completo en slide (autocontenido — no depender del libreto)
\newenvironment{planstatement}{%
  \begin{tcolorbox}[
    enhanced,
    arc=4pt,
    boxrule=0.45pt,
    ...
    borderline west={2.5pt}{0pt}{uniaccent},
  ]
  \small
}{%
  \end{tcolorbox}%
...
% VD del artefacto (destacada)
\newenvironment{planvdartefacto}{%
  \begin{tcolorbox}[
    enhanced,
    arc=4pt,
    boxrule=0.55pt,
    colframe=uniaccent!85,
    colback=uniaccent!12,
    width=\linewidth,
    boxsep=0pt,
    left=8pt, right=8pt, top=5pt, bottom=5pt,
    title={\bfseries Variable dependiente del artefacto (rendimiento global)},
    fonttitle=\normalsize,
    coltitle=uninavy,
  ]
  \small
